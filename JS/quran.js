...
for (let index = 0; index < 114; index++) {
    surahContainer.innerHTML += `
        <div class="surah">
            ...
            <h2 class="surahType">النوع: ${surahs[index].type}</h2>
            <button onclick="
...
for (let i = 0; i < 99; i++) {
    Allah_names.innerHTML += `<div class="name"><h1>الأسم: ${namesOfAllah[i].name}</h1><p>المعنى: ${namesOfAllah[i].meaning}</p></div>`
}